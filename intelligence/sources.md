...
| SRC-007 | [SpaceX — Civil Engineer, Land Development (Starbase Infrastructure - Louisiana)](https://job-boards.greenhouse.io/spacex/jobs/8814619002); [individual API](https://boards-api.greenhouse.io/v1/boards/spacex/jobs/8814619002) | `2026-09-17T11:00:35-04:00` (`first_published`); modified `2026-09-17T11:01:07-04:00` | 2026-09-21 | HTTP 200 for exact posting and API; ID `8814619002`, exact title, and `Pecan Island, LA` present in the active [official board list](https://boards-api.greenhouse.io/v1/boards/spacex/jobs) | FACT-020; ROLE-003 |
| SRC-008 | [SpaceX — Sr. Construction Project Manager (Starship Infrastructure - Louisiana)](https://job-boards.greenhouse.io/spacex/jobs/8814705002); [individual API](https://boards-api.greenhouse.io/v1/boards/spacex/jobs/8814705002) | `2026-09-16T12:49:40-04:00` (`first_published`); modified `2026-09-17T12:05:40-04:00` | 2026-09-21 | HTTP 200 for exact posting and API; ID `8814705002`, exact title, and `Pecan Island, LA` present in the active [official board list](https://boards-api.greenhouse.io/v1/boards/spacex/jobs) | FACT-021; ROLE-004 |
...
On 2026-09-21 UTC, the exact official pages and individual API records for SRC-007 and SRC-008 returned HTTP 200. Both IDs were present in the active official SpaceX board list with matching titles, locations, publication timestamps, and modification timestamps. The API `first_published`, `updated_at`, and retrieval date remain separate. Both postings list Pecan Island, LA, while stating an initial Starbase, Texas assignment and required Louisiana relocation in early 2027. These records establish two time-bound vacancies only, not ground-breaking, completed pads or other assets, approvals, awarded packages, or construction dates.
